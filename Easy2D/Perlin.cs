...
namespace Easy2D
{
    ...
    public class Perlin
    {
        public static Perlin Instance { get; private set; }

        //My brain is way too little to understand any of this, crazy stuff
        ...
        /// Constructor
        /// </summary>
        /// <param name="seed">The seed to use, 0 is the OG perlin noise</param>
        /// <param name="repeat">If we have any repeat on, change the coordinates to their "local" repetitions.
        /// IE if 10 here and x // y // z is 11, it wraps around to 1</param>
        public Perlin(int seed = 0, int repeat = -1)
        {
            this.repeat = repeat;
            ...
            if (seed != 0)
            {
                ...
                Array.Sort(permutation, new Comparison<int>((x, y) =>
                {
