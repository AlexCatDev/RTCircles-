...
namespace OpenTK.WinForms
{
    ...
    internal class NativeInput : INativeInput
    {
        ...
        /// </summary>
        private readonly Windowing.Desktop.NativeWindow _nativeWindow;
        ...
        internal NativeInput(Windowing.Desktop.NativeWindow nativeWindow)
        {
        ...
        public bool IsKeyDown(Windowing.GraphicsLibraryFramework.Keys key)
        ...
        public bool IsKeyPressed(Windowing.GraphicsLibraryFramework.Keys key)
