...
namespace OpenTK.WinForms
{
    ...
    public interface INativeInput
    {
        ...
        bool IsKeyDown(Windowing.GraphicsLibraryFramework.Keys key);
        ...
        bool IsKeyPressed(Windowing.GraphicsLibraryFramework.Keys key);
        ...
        bool IsKeyReleased(Windowing.GraphicsLibraryFramework.Keys key);
