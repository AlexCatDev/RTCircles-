...
namespace Silk.NET.WinForms
{
    ...
    internal class GLControlDesignTimeRenderer : IDisposable
    {
        ...
        /// </summary>
        private readonly System.Windows.Forms.Timer _designTimeTimer;
        ...
        /// </summary>
        private static (Vector3D<float>, Vector3D<float>)[] CubeLines { get; } = new (Vector3D<float>, Vector3D<float>)[]
        {
            (new Vector3D<float>(-1, -1, -1), new Vector3D<float>(+1, -1, -1)),
            (new Vector3D<float>(-1, -1, -1), new Vector3D<float>(-1, +1, -1)),
            (new Vector3D<float>(-1, -1, -1), new Vector3D<float>(-1, -1, +1)),
        ...
        public GLControlDesignTimeRenderer(GLControl owner)
        {
            ...
            _designTimeTimer = new System.Windows.Forms.Timer();
            _designTimeTimer.Tick += OnDesignTimeTimerTick;
            _designTimeTimer.Interval = 33;
            ...
            float yaw = 0, float pitch = 0, float roll = 0)
        {
            ...
            Matrix3X3<float> matrix = Matrix3X3.CreateRotationZ(roll)
            ...
            using System.Drawing.Pen pen = new System.Drawing.Pen(brush, 2);
        ...
        public void Paint(System.Drawing.Graphics graphics)
        {
            ...
            DrawCube(bitmapGraphics, System.Drawing.Color.MediumPurple,
