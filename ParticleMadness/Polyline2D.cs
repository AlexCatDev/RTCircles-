...
namespace ParticleMadness
{
        ...
        public class Polyline2D
    {
        ...
        */
        ...
        private void createTriangleFan(Graphics g, Vector2 connectTo, Vector2 origin, Vector2 start, Vector2 end, bool clockwise)
        {
        ...
        public void Render(Graphics g, List<Vector2> points, float thickness,
            ...
            bool allowOverlap = false)
        {
            ...
            else if (endCapStyle == EndCapStyle.ROUND)
            {
                ...
                createTriangleFan(g, firstSegment.center.start, firstSegment.center.start,
                                  firstSegment.edge1.start, firstSegment.edge2.start, false);
                createTriangleFan(g, lastSegment.center.end, lastSegment.center.end,
            ...
            else if (endCapStyle == EndCapStyle.JOINT)
            {
                ...
                createJoint(g, lastSegment, firstSegment, jointStyle,
            ...
            for (int i = 0; i < segments.Count; i++)
            {
                ...
                {
                    createJoint(g, segment, segments[i + 1], jointStyle,
        ...
        private float angleFunc(in Vector2 a, in Vector2 b)
        {
            return MathF.Acos(Vector2.Dot(a, b) / a.Length * b.Length);
        }

        private void createJoint(Graphics g, in PolySegment segment1, in PolySegment segment2,
            ...
            ref Vector2 nextStart1, ref Vector2 nextStart2, bool allowOverlap)
        {
            ...
            else
            {
                ...
                else if (jointStyle == JointStyle.ROUND)
                {
                    ...
                    createTriangleFan(g, innerSec, segment1.center.end, outer1.end, outer2.start, clockwise);
                }
                else
                {
                    //assert(false);
