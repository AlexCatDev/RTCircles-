...
namespace RTCircles
{
    ...
    public static class PathApproximator
    {
        ...
        /// <returns>A list of vectors representing the piecewise-linear approximation.</returns>
        public static List<Vector2> ApproximateBSpline(List<Vector2> controlPoints, int p = 0)
        {
        ...
        /// </summary>
        /// <param name="controlPoints">The control points.</param>
        /// <param name="catmull_detail">The amount of pieces to calculate for each control point quadruplet.</param>
        /// <returns>A list of vectors representing the piecewise-linear approximation.</returns>
        public static List<Vector2> ApproximateCatmull(List<Vector2> controlPoints, int catmull_detail = 50)
        {
        ...
        public static Rectangle CircularArcBoundingBox(List<Vector2> controlPoints)
        {
            CircularArcProperties pr = circularArcProperties(controlPoints);
            if (!pr.IsValid)
        ...
        /// <param name="controlPoints">Three distinct points on the arc.</param>
        /// <returns></returns>
        private static CircularArcProperties circularArcProperties(List<Vector2> controlPoints)
        {
