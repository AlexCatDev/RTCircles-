...
namespace AndroidTest
{
    ...
    public class MusicFreckle : Drawable
    {
        ...
        public override void Update(float delta)
        {
            ...
            if (new Rectangle(new Vector2(-100), new Vector2(2020, 1180)).IntersectsWith(Bounds) == false)
                IsDead = true;
        }
    }*/
    ...
    public class SoundVisualizer
    {
        ...
        public Rectangle Bounds => new Rectangle(Position - new Vector2(Radius), new Vector2(Radius * 2f));
